from engines import CollisionsEngine
    ...
    def run_game():
        ...
        while run:
            ...
            if not GameRunner.game_is_paused():
                ScoreKeeper.keep_score(GameRunner.ball)
                ...
                HistoryKeeper.add(GameRunner.player1, "player1", True)
                HistoryKeeper.add(GameRunner.player2, "player2", True)
